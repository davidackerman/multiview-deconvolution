...
TMvec = [2177]; %time points to be registered

imPathPattern = ['S:\SiMView3\15-05-05\Dme_L1_57C10-GCaMP6s_20150505_205450.corrected\SPM00\TM??????\']; %base folder where original images are located. ??? characters will be filled with the TM value
...
FWHMpsf = [0.8, 0.8, 6.0]; %theoretical full-width to half-max of the PSF in um.

outputFolderPattern = ['T:\temp\registration\20150505_205450_GCaMP6\TM??????\'];%outputfolder for debugging purposes. Leave empty for no debugging. This folder should be visible to the cluster if you want to run it on it
