function [raw_PSF, trimmed_transformed_PSF] = generate_raw_and_transformed_psf(T_in_row_form, spacing, FWHM)
    % spacing should be in xyz order, ditto FWHM
    
    % Generate the raw PSF
    raw_PSF = generate_PSF(spacing, FWHM) ;
