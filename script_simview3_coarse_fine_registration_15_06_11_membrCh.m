...
for TM = TMvec
    ...
    outputFolder = ['T:\temp\deconvolution\15_06_11_fly_functionalImage_TM' TMstr '_membrh\']
    
    transposeOrigImage = true;
    RANSACparameterSet = 3;%1->functional imaging; 2->nuclear channel development; 3->membrane channel development
