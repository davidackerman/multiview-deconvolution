...
%%
if( isMembrCh == true )
    imPath = ['T:\temp\deconvolution\15_06_11_fly_functionalImage_TM' TMstr 'membrCh_Fiji\']
else
    imPath = ['T:\temp\deconvolution\15_06_11_fly_functionalImage_TM' TMstr '_Fiji\']
end
...
J = multiviewDeconvolutionLucyRichardson(imCell,imPSF, weightsCell, backgroundOffset, [numIterIni numIterFinal], lambdaTV, 0, [imPath 'LRdeconvolution_iter']);
