...
for TM = TMvec
    ...
    TMstr = num2str(TM,'%.6d');
    imPath = ['S:\SiMView3\15-05-05\Dme_L1_57C10-GCaMP6s_20150505_185415.corrected\SPM00\TM' TMstr '\'];
    ...
    outputFolder = ['T:\temp\deconvolution\20150505_185415_GCaMP6_TM' TMstr '\']
