...
TMvecCell = {[1000]};
experimentTagVec = {'20150710_154449'}
...
for ee = 1:length(experimentTagVec)
    ...
    for TM = TMvec
        ...
        TMstr = num2str(TM,'%.6d');
        imPath = ['S:\SiMView3\15-07-10\Dre_HuC_H2BGCaMP6s_0-1_' experimentTag '.corrected\SPM00\TM' TMstr '\'];
        ...
        samplingXYZ = [0.40625, 0.40625, 5.980];%in um
